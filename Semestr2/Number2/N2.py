...
if __name__ == '__main__':
    ...
    probesPos_m = [0.134, 0.31]
    d1 = 0.05
    d2 = 0.05
    d3 = 0.05

    # Параметры слоев
    layers_cont = [LayerContinuous(0.5, 0.55,  eps=8.2, sigma=0.0),
                   LayerContinuous(0.55, 0.6, eps=6.7, sigma=0.0),
                   LayerContinuous(0.6, 0.65, eps=8.2, sigma=0.0),
                   LayerContinuous(0.65, 0.70, eps=3.0, sigma=0.0)
                   ]
